export default class BBCodeParser {
    ...
    static parsers = {
        ...
        'media-youtube': {
            ...
            replace: '<iframe class="media-yt" width="560" height="315" src="//www.youtube.com/embed/$1" frameborder="0" allowfullscreen></iframe>',
            content: '$1'
        },
        'youtube': {
     ...
     */
    static parse(source) {
        for (const [key, tag] of Object.entries(this.parsers)) {
    ...
    /**
     * Replaces breaks with HTML line breaks.
     * @param {string} source
     * @return {string} The source with breaks replaced.
     */
    static replaceBreaks(source) {
    ...
    /**
     * Removes all BBCode tags from the source.
     * @param {string} source The source with BBCode.
     * @return {string} The stripped source.
     */
    static stripBBCodeTags(source) {
        for (const tag of Object.entries(this.parsers)) {
