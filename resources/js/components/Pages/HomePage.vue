<template>
    <div class="landing-page h-full w-full">
        ...
        <section class="flex flex-col align-items-center vh-50 color-light" style="background: #131128">
            <div class="d-grid d-grid-12">
                ...
                <div class="grid-full grid d-grid-auto mt-5">
                    <div class="card home-card flex flex-col justify-content-center">
                ...
                <div class="grid-full flex flex-col align-center pt-5">
                    <a href="/discord"
                       target="_blank"
