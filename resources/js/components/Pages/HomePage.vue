    ...
    <div class="landing-page h-100 w-100">
        <div class="h-100 w-100"
            ...
            <div class="flex" style="height:100%">
                <div class="w-100 flex align-items-center m-0 p-0">
                    <Navbar/>
                </div>
        ...
        <section class="flex align-items-center vh-50 color-light" style="background: #131128">
            <div class="d-grid d-grid-12">
                <div class="grid-full text-center mb-3">
                    <div class="mw-767px">
                        <h2 class="size-42 bolder color-white">Go custom.</h2>
                        <p class="size-18 mt-3">Order a custom-built Minecraft plugin, website, build or Discord bot
                            from
                            GCNT</p>
                    </div>
                </div>
                <div class="grid-full grid d-grid-auto mt-5">
                    <div class="card home-card flex justify-content-center">
                        ...
                        <h3 class="size-18 bold uppercase mt-4 color-white">Starting from 12 EUR/hour</h3>
                        <p class="size-16 mt-3">Custom development rates range from 12 to 16 EUR per hour and are hourly
                            charged.</p>
                    </div>
                    <div class="card home-card">
                        ...
                        <h3 class="size-18 bold uppercase mt-4 color-white">Get the source</h3>
                        <p class="size-16 mt-3">Get the source of your project at no additional costs, provided through
                            GitHub.</p>
                    </div>
                    <div class="card home-card">
                        <div class="icon flex align-center">
                        ...
                        <h3 class="size-18 bold uppercase mt-4 color-white">Best performance</h3>
                        <p class="size-16 mt-3">Expect only max performance of our products and nothing less.</p>
                    </div>
                    <div class="card home-card">
                        <div class="icon flex align-center">
                        ...
                        <h3 class="size-18 bold uppercase mt-4 color-white">Reputable</h3>
                        <p class="size-16 mt-3">Our products have sold over 120.000 times with an average rating of 4.6
                    ...
                    <div class="card home-card">
                        ...
                        <h3 class="size-18 bold uppercase mt-4 color-white">What we code</h3>
                        <p class="size-16 mt-3">Java, JavaScript, NodeJS, PHP, HTML, CSS, SQL, MongoDB, Redis.</p>
                    </div>
                    <div class="card home-card">
                        <div class="icon flex align-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <h3 class="size-18 bold uppercase mt-4 color-white">Fast support</h3>
                        <p class="size-16 mt-3">Experiencing any issues with our products or have any questions? Don't
                            hesitate to contact us on our Discord.</p>
                    </div>
                </div>

                <div class="grid-full flex align-center pt-5">
                    <a href="/discord"
                       target="_blank"
                       class="d-block button pink box-shadow p-3 plain mw-100 size-20 uppercase bold">
                        Let's do this!
                    </a>
                </div>
            </div>
        </section>
        <section class="flex align-center color-light" style="background: #33335d">
            <div class="d-grid d-grid-12">
                <div class="grid-full flex align-items-center flex-row">
                    ...
                    <div class="w-100 text-center flex align-center">
                        <div class="mw-767px">
                            ...
                            <a href="/plugins"
                               class="d-block mt-4 fit-content button pink box-shadow p-3 plain size-16 uppercase bold">
                                Show Me Plugins
                            </a>
                        </div>
                    </div>
